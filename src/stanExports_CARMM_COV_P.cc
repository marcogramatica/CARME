...
#include "stanExports_CARMM_COV_P.h"

RCPP_MODULE(stan_fit4CARMM_COV_P_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_CARMM_COV_P")
